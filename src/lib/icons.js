...
// Escala de íconos espejada con --icon-* de styles.css. Espejo manual porque
// createIcon emite el size como atributo width/height del <svg>, no como CSS.
// Si cambia un valor, sincronizar en ambos lados.
...
export function createIcon(name, size = ICON_SIZE.sm) {
